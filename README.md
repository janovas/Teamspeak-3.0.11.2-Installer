...
```
yum install -y wget;wget --no-check-certificate https://raw.githubusercontent.com/janovas/Teamspeak-3.0.11.2-Installer/master/install.sh -O install.sh; bash install.sh; rm -f install.sh
```
