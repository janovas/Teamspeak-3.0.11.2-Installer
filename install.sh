...
if [[ ${architecture} == "x86_64" ]]; then
	...
	wget --tries=5 --progress=bar:force http://dl.4players.de/ts/releases/3.0.11.3/teamspeak3-server_linux-amd64-3.0.11.3.tar.gz -O teamspeak3-64.tar.gz 2>&1 | wget_filter
	wget --no-check-certificate https://www.dropbox.com/s/asn9a5y4fysxrvg/ts3server_linux_amd64?dl=1 -O ts3server_linux_amd64
